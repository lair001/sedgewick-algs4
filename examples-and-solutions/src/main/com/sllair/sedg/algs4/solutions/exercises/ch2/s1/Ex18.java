...
public class Ex18 {
    ...
    public static class TracedInsertion {

        // This class should not be instantiated.
        private TracedInsertion() {
        }
        ...
        private static void show(Double[] a, int i, int j) {
            ...
            for (int k = 0; k < a.length; k++) {
                if (i == -1 && j == -1) {
                    redraw(a, k, Color.BLACK);
                } else if (k == j) {
                    redraw(a, k, Color.RED);
                } else if (k <= i && k > j) {
                    redraw(a, k, Color.BLACK);
                } else {
                    redraw(a, k, Color.LIGHT_GRAY);
                }
        ...
        private static void redraw(Double[] a, int i, Color color) {
    ...
    public static class TracedSelection {

        // This class should not be instantiated.
        private TracedSelection() {
        }
    ...
    public static double trace(String alg, Double[] a) {
        Stopwatch sw = new Stopwatch();
        if (alg.equals("Insertion")) Ex18.TracedInsertion.sort(a);
        else if (alg.equals("Selection")) Ex18.TracedSelection.sort(a);
